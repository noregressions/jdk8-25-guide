...
**8–10** computed serialVersionUID includes the synthetic bridge javac emits · **11–26** nestmates remove that bridge, so the computed UID changes and stored objects stop deserialising
